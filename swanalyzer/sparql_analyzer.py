...
class SPARQLAnalyzer(SWAnalyzer):
    ...
    def __init__(self, sparql_endpoint, identifier, configstring, store='SQLite', proxy=None, subprocess=True):
        SWAnalyzer.__init__(self, identifier, configstring, store, proxy, subprocess)
